...
// .wrangler/tmp/bundle-Dzdluq/checked-fetch.js
  ...
  "node_modules/xml-js/lib/xml2js.js"(exports, module) {
    ...
    function onStartElement(name, attributes) {
      ...
      if (options.compact) {
        ...
        if (!(name in currentElement) && (isArray3(options.alwaysArray) ? options.alwaysArray.indexOf(name) !== -1 : options.alwaysArray)) {
          currentElement[name] = [];
        }
        if (currentElement[name] && !isArray3(currentElement[name])) {
          currentElement[name] = [currentElement[name]];
        }
        if (isArray3(currentElement[name])) {
...
var require_rss2 = __commonJS({
  "node_modules/feed/lib/rss2.js"(exports) {
    ...
    var formatCategory = function(category) {
      var name = category.name, domain2 = category.domain;
      return {
        _text: name,
        _attributes: {
          domain: domain2
...
// .wrangler/tmp/bundle-Dzdluq/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();

// .wrangler/tmp/bundle-Dzdluq/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();
...
init_process();
init_buffer();
var import_feed = __toESM(require_feed());
var src_default = {
